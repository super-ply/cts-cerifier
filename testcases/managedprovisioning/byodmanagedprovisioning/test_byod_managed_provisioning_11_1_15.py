...
# @Time: 2021/7/22
# @File: test_byod_managed_provisioning_11_1_15.py
# @Author: pengleiyang
...
class OpenAppCrossProfilesFromThePersonalSid(unittest.TestCase):
    ...
    def test_byod_managed_provisioning_11_1_15(self):
        for i in range(10):
            time.sleep(10)
            if self.d.exists(text="Open app cross profiles from the work side"):
                self.d(text="Open app cross profiles from the work side").click()
                time.sleep(2)
