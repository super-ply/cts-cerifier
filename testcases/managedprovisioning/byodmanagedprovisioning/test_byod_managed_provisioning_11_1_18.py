...
class NoneMarketAppInstallationRestrictions(unittest.TestCase):
    def setUp(self):
    ...
    def test_byod_managed_provisioning_11_1_18(self):
        for i in range(10):
            time.sleep(10)
            if self.d.exists(text="Non-market app installation restrictions"):
                self.d(text="Non-market app installation restrictions").click()
                time.sleep(2)
