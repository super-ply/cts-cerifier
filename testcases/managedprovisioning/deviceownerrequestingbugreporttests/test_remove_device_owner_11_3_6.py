...
# @Time: 2021/6/15
# @File: test_remove_device_owner_11.3.6
# @Author: pengleiyang
# @E-mail: pengleiyang@huaqin.com
# @Desc: test_sharing _of_requested_bugreport_declined_while_being_taken_11.3.6自动化测试脚本
...
class RemoveDeviceOwner(unittest.TestCase):
    def setUp(self):
